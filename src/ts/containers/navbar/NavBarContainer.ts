...
import { navBarItem, navBarItemWithButtons, navBarItemWithDropdown } from "../../ui/layout/navbar/navbar-item";
...
class NavBarContainer extends BaseContainer {
    ...
    onInit(){
        ...
        navBarBrand.insertAdjacentHTML('beforeend', burgerMenuComponent('navbar-burger-menu', 'navbar-menu'))
        navBar.insertAdjacentHTML('beforeend', navBarMenu("navbar-menu"))  
        const navBarStart = document.getElementById('navbar-start');
        navBarStart.insertAdjacentHTML('beforeend', navBarItem({ isSelected: false, href: "#teas", content: "Our Teas"}))
        navBarStart.insertAdjacentHTML('beforeend', navBarItemWithDropdown("navbar-menu-dropdown"));
        ...
        navBarMenuDropdown.insertAdjacentHTML('beforeend', navBarDropDown(dropdownLists))  
        ...
        navBarEnd.insertAdjacentHTML('beforeend', navBarItemWithButtons(navBarEndButtons));
